...
import './i-am-away-auto-created-6.css'

const IAmAwayAutoCreated6 = (props) => {
  return (
    <div className="-am-away-auto-created6-container">
      <Helmet>
        <title>I-am-away-auto-created-6 - exported project</title>
        <meta
          property="og:title"
          content="I-am-away-auto-created-6 - exported project"
        />
      </Helmet>
      <div className="-am-away-auto-created6-frame9afterautomationcreated">
        <div className="-am-away-auto-created6-container1">
          ...
          <img
            ...
            className="-am-away-auto-created6-rectangle13"
          />
          <span className="-am-away-auto-created6-text09">
...
export default IAmAwayAutoCreated6
