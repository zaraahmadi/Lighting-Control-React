...
import './live-chat-page-8.css'

const LiveChatPage8 = (props) => {
  return (
    <div className="live-chat-page8-container">
      <Helmet>
        <title>live-chat-page-8 - exported project</title>
        <meta
          property="og:title"
          content="live-chat-page-8 - exported project"
        />
      </Helmet>
      <div className="live-chat-page8-container1">
        <div className="live-chat-page8-frame1-live-chat">
          ...
          <span className="live-chat-page8-text05">
            ...
            <span>A specialist joined the Chat</span>
          </span>
          ...
          <span className="live-chat-page8-text20">
            <span>Brian - 10:45 AM</span>
          </span>
          <span className="live-chat-page8-text22">
            <span>Brian - 10:45 AM</span>
          </span>
          <span className="live-chat-page8-text24">
            <span>Brian is typing - 10:48AM</span>
          </span>
          <span className="live-chat-page8-text26">
            <span>Zahra - 10: 46 AM</span>
          </span>
          ...
          <span className="live-chat-page8-text30">
            <span>
              Hi Zahra, How may I assist you today?
              <span
          ...
          <span className="live-chat-page8-text32">
            <span>
              <span>
                Hi, I have an issue with adding
                <span
                  dangerouslySetInnerHTML={{
                    __html: ' ',
                  }}
              ...
              <br></br>
              <span>a new light to my app?</span>
            </span>
          </span>
        </div>
      </div>
      <div className="live-chat-page8-social-bar">
        <a
        ...
        >
          <svg
            ...
            className="live-chat-page8-icon"
          >
        ...
        >
          <svg
            ...
            className="live-chat-page8-icon02"
          >
        ...
        >
          <svg
            ...
            className="live-chat-page8-icon04"
          >
        ...
        <svg
          viewBox="0 0 877.7142857142857 1024"
          className="live-chat-page8-icon06"
        >
