...
import './support-page-7.css'

const SupportPage7 = (props) => {
  return (
    <div className="support-page7-container">
      <Helmet>
        <title>Support-Page-7 - exported project</title>
        <meta property="og:title" content="Support-Page-7 - exported project" />
      </Helmet>
      <div className="support-page7-frame1-support-team">
        <div className="support-page7-container1">
          <img
            alt="Rectangle11523"
          ...
          <Link to="/live-chat-page-8" className="support-page7-navlink">
            <img
              alt="Rectangle151521"
              src="/playground_assets/rectangle151521-0o6.svg"
              className="support-page7-rectangle15"
            />
          </Link>
          <span className="support-page7-text05">
